    ...
    for file in os.listdir(ndpi_folder):
        if file.endswith('.ndpi'):
            ...
            try:
                ...
                random_annotations = random.sample(anote_list, 1000)

                anote_xml = write_xml(annotations, start_id, random_annotations, X_Reference, Y_Reference, nm_p)
...
if __name__ == '__main__':
    ...
    folder_path = r'D:\Shreyan\Development\Test'
