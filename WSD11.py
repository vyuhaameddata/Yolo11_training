...
class GlobalVars:
    def __init__(self):
        ...
        self.wsi = ''
        self.weights = r'w\best_abnormal.pt'
        self.source = ''
        self.batch_size = 32
        self.img_size = 640
        self.conf_thres = 0.5
        ...
        self.augment = False
        self.no_trace = True
        self.cat_weights = r'w\cat.pt'
    def __init__(self, fldr):
        self.folder = fldr
        self.wsi = ''
        self.weights = r'w\abnormal.pt'
        self.source = ''
        self.batch_size = 32
        self.img_size = 640
        self.conf_thres = 0.5
...
def run_segment(wsi_path,model,pred_list,tile_size=1024,batch_size=12):
    anote =[]
    set_logging()
    device = select_device(globalVars.device)    
